...
matrix is the full cross-product.  The devices that do pin ``compatible_msk``
...
EXPECTED = {
    ...
    ("myolegs22", "KFoot_L1"): (39, 18, 40, 43),
    ("myolegs22", "NEUankle_L1"): (38, 19, 40, 43),
    ("myolegs22", "OpenExo_L1"): (39, 24, 44, 43),
    ("myolegs22", "OpenSourceLeg_A_L1"): (38, 19, 39, 41),
    ("myolegs22", "OpenSourceLeg_KA_L1"): (30, 17, 38, 43),
    ("myolegs22", "STRIDE_L2"): (49, 24, 58, 59),
    ...
    ("myolegs26", "KFoot_L1"): (47, 22, 40, 43),
    ("myolegs26", "NEUankle_L1"): (46, 23, 40, 43),
    ("myolegs26", "OpenExo_L1"): (47, 28, 44, 43),
    ("myolegs26", "OpenSourceLeg_A_L1"): (46, 23, 39, 41),
    ("myolegs26", "OpenSourceLeg_KA_L1"): (38, 21, 38, 43),
    ("myolegs26", "STRIDE_L2"): (57, 28, 58, 59),
    ...
    ("myolegs", "KFoot_L1"): (34, 71, 32, 44),
    ("myolegs", "NEUankle_L1"): (33, 72, 32, 44),
    ("myolegs", "OpenExo_L1"): (35, 82, 36, 44),
    ("myolegs", "OpenSourceLeg_A_L1"): (33, 72, 31, 42),
    ("myolegs", "OpenSourceLeg_KA_L1"): (26, 67, 32, 44),
    ("myolegs", "STRIDE_L2"): (45, 82, 50, 60),
    ...
    ("myofullbody", "KFoot_L1"): (128, 407, 106, 108),
    ("myofullbody", "NEUankle_L1"): (127, 408, 106, 108),
    ("myofullbody", "OpenExo_L1"): (129, 418, 110, 108),
    ("myofullbody", "OpenSourceLeg_A_L1"): (127, 408, 105, 106),
    ("myofullbody", "OpenSourceLeg_KA_L1"): (120, 403, 106, 108),
    ("myofullbody", "STRIDE_L2"): (139, 418, 124, 124),
